...
<body>
    ...
    <main class="page service-page">
        <section class="clean-block clean-services dark">
            <div class="container">
                ...
                <canvas id="micanvas" style="width : 800px ; height : 400px ; border : 1px black solid ;"></canvas> 
            </div>
        </section>
    </main>
    ...
    <script type="text/javascript">
        ...
        var context2 =document.querySelector("#micanvas").getContext('2d');
        context.beginPath();
        context2.beginPath();
        context.arc(75,75,50,0,Math.PI*2,true);
        context2.arc(190, 75,50,0,Math.PI*2,true);
        context.stroke();
        context2.stroke();
